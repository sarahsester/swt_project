...
def create_df_level2(somebody, current_latitude, current_longitude):
    ...
    # if a name string is given
    else:
        # Query which is searching for persons giving a string containing the requested name and returning named resources
        query = '''
            prefix bd:       <http://www.bigdata.com/rdf#>
            prefix wd:       <http://www.wikidata.org/entity/>
            prefix wdt:      <http://www.wikidata.org/prop/direct/>
